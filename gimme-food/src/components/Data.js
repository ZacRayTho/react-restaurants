export const data = [
    ...
    "category": "Breakfast",
    "description": "Two poached eggs, Canadian bacon and hollandaise",
    "price": 9.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Thai",
    "category": "Appetizer",
    "description": "Marinated and grilled beef skewers served with a peanut dipping sauce",
    "price": 6.99,
    "spicy_level": 3
    },
    {
    ...
    "category": "Dinner",
    "description": "Two soft tortillas filled with seasoned pork, onions, cilantro, and salsa",
    "price": 11.99,
    "spicy_level": 2
    },
    {
    ...
    "cuisine_type": "Thai",
    "category": "Dinner",
    "description": "A spicy Thai curry made with coconut milk, green chilies, chicken, and vegetables",
    "price": 13.99,
    "spicy_level": 4
    },
    {
    ...
    "cuisine_type": "Mexican",
    "category": "Appetizer",
    "description": "Freshly made salsa and crispy tortilla chips",
    "price": 5.99,
    "spicy_level": 0
    },
    {
    ...
    "category": "Lunch",
    "description": "Grilled chicken, vegetables, and teriyaki sauce",
    "price": 10.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Italian",
    "category": "Dinner",
    "description": "Grilled chicken and fettuccine noodles tossed in a creamy Alfredo sauce",
    "price": 14.99,
    "spicy_level": 1
    },
    {
    ...
    "category": "Dinner",
    "description": "Beer-battered cod and crispy fries served with tartar sauce",
    "price": 12.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Japanese",
    "category": "Appetizer",
    "description": "A sushi roll filled with spicy tuna, avocado, and cucumber",
    "price": 8.99,
    "spicy_level": 4
    },
    {
    ...
    "cuisine_type": "Italian",
    "category": "Dinner",
    "description": "A pizza topped with pepperoni, sausage, bacon, and ham",
    "price": 15.99,
    "spicy_level": 1
    },
    {
    ...
    "cuisine_type": "Italian",
    "category": "Appetizer",
    "description": "A smaller portion of a classic Caesar salad",
    "price": 4.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Mexican",
    "category": "Dinner",
    "description": "Sizzling strips of steak with peppers and onions, served with tortillas and rice",
    "price": 17.99,
    "spicy_level": 2
    },
    {
    ...
    "cuisine_type": "Italian",
    "category": "Dinner",
    "description": "Penne pasta tossed in a creamy tomato vodka sauce with grilled chicken and spinach",
    "price": 13.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Mexican",
    "category": "Appetizer",
    "description": "Grilled flour tortilla filled with chicken, cheese, and vegetables, served with sour cream and salsa",
    "price": 10.99,
    "spicy_level": 1
    },
    {
    ...
    "category": "Lunch",
    "description": "Rice noodles in a flavorful broth with thinly sliced beef, bean sprouts, and fresh herbs",
    "price": 12.99,
    "spicy_level": 2
    },
    {
    ...
    "cuisine_type": "American",
    "category": "Lunch",
    "description": "A classic sandwich with melted cheese between two slices of buttery bread, served with tomato soup",
    "price": 8.99,
    "spicy_level": 0
    },
    {
    ...
    "category": "Lunch",
    "description": "A spicy and tangy soup with chicken, tofu, and vegetables",
    "price": 6.99,
    "spicy_level": 4
    },
    {
    ...
    "cuisine_type": "Thai",
    "category": "Lunch",
    "description": "Stir-fried wide rice noodles with chicken, broccoli, and egg in a sweet soy sauce",
    "price": 11.99,
    "spicy_level": 1
    },
    {
    ...
    "cuisine_type": "French",
    "category": "Appetizer",
    "description": "A creamy wheel of brie baked in puff pastry, served with crackers",
    "price": 12.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Italian",
    "category": "Lunch",
    "description": "A creamy tomato soup with fresh basil, served with a grilled cheese sandwich",
    "price": 7.99,
    "spicy_level": 0
    },
    {
    ...
    "cuisine_type": "Indian",
    "category": "Dinner",
    "description": "Grilled chicken in a creamy tomato-based sauce with aromatic spices, served with basmati rice and naan",
    "price": 15.99,
    "spicy_level": 2
    },
    {
    ...
    "category": "Appetizer",
    "description": "Tender and flavorful grilled octopus served with a lemon garlic sauce",
    "price": 12.99,
    "spicy_level": 1
    },
    {
    ...
    "cuisine_type": "American",
    "category": "Breakfast",
    "description": "Thick slices of bread soaked in a mixture of",
    "price": 11.99,
    "spicy_level": 0
    }
    ]