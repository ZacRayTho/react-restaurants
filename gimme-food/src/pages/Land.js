            ...
            <div className="mx-auto bg-white w-75">
                <div className="row">
                    ...
                    <div className="col-6 my-5 ">
                        ...
                        <img className="d-flex mx-auto mw-100" src="./img/headChef.jpg" alt="master chef training apprentice"></img>
                    </div>
                    <div className="col-6 my-5">
                        <h4 className="text-center"> An average night at Justin's, place your reservations early!</h4>
                        <img className="d-flex mx-auto mw-100" src="./img/JustinBusyNight.jpg" alt="busy night at justin's"></img>
                    </div>
                </div>
            </div>
        </>
